...
if($form) {
  ...
  $repetida = selectSQLUnique("SELECT * FROM colaboradores_cripto WHERE login LIKE '$login'");

  if(empty($repetida)) {
    iduSQL("INSERT INTO colaboradores_cripto (nome, apelido, nif, login, senha) VALUES ('$nome', '$apelido', '$nif', '$login', '$pw')");
