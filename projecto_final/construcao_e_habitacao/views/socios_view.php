...
<main class="container-fluid">
  ...
  <div class="row justify-content-center">
    <div class="col-10  mx-auto p-0 text-center poppins-regular cinza-escuro">        
      <h1 class="titulo-main m-0"><?= $socios["titulo"]; ?></h1>
    </div>
  </div>

  <!-- Texto Socios -->
  <div class="row">
    <div class="col-10 px-2 px-xl-4 col-xl-9 mx-auto espacamento-texto-main-socios cinza-escuro poppins-light texto-main"> 
