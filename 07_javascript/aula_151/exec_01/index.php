...
<head>
  ...
  <script src="public/css/Produto.js" defer></script>
</head>
<body>
            ...
            <tr class="<?= ($id_edit == $p["id"]) ? "active" : ""; ?>">  
              ...
              <td> 
                <a class="d-inline-block" href="#">
                  <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="addCarrinho('<?= $p['id'] ?>', '<?= $p['nome'] ?>', '<?= $p['preco'] ?>', '<?= $p['marca'] ?>', 4)">Adicionar ao Carrinho</button>
                </a>                  
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div id="lista" class="container-fluid"> 
                  <div class="row mt-4 align-items-center text-end">                                      
                    <div class="col-10">Total <span class="total">(0)</span></div>
                  </div>
                </div>
